  ...
  const that = {
    ...
    update_threeCamera: function(sizing, threeCamera){
      ...
      if (threeCamera.matrixAutoUpdate){
        threeCamera.far = _settings.cameraZFar;
        threeCamera.near = _settings.cameraZNear;
      ...
      let fov = (_spec.fov === 0 ) ? _settings.cameraMinVideoDimFov * fovFactor : _spec.fov;
